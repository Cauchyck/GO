...
// 请填写您的AccessKeyId。
var accessKeyId string = "LTAI5t7fj52mUUWSmLZRtZ59"
// 请填写您的AccessKeySecret。
var accessKeySecret string = "U92z3L37nABteJjgiDSD0x4PepsKu9"
// host的格式为 bucketname.endpoint ，请替换为您的真实信息。
var host string = "http://mxshop-go.oss-cn-shanghai.aliyuncs.com" 
// callbackUrl为 上传回调服务器的URL，请将下面的IP和Port配置为您自己的真实信息。
var callbackUrl string = "https://7f9538c698.vicp.fun";
// 用户上传文件时指定的前缀。
